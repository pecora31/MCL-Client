        ...
        <div className="p-6 space-y-5">
          ...
          <div className="p-4.5 rounded-2xl bg-white/[0.02] border border-white/5 flex items-center justify-between gap-3">
            ...
            <div className="text-right shrink-0">
              <span className="text-xs px-3 py-1 rounded-lg bg-white/5 border border-white/10 text-slate-300 font-medium">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="pt-0.5">
                <button
                  type="button"
                  role="checkbox"
                  aria-checked={deleteVersionFiles}
                  onClick={() => setDeleteVersionFiles(!deleteVersionFiles)}
                  className={`w-5 h-5 rounded-lg border flex items-center justify-center transition-all duration-150 cursor-pointer shrink-0 ${
                    deleteVersionFiles
                      ? 'bg-[var(--accent-color)] border-[var(--accent-color)] text-[#070a12] shadow-sm'
                      : 'bg-black/50 border-white/20 hover:border-white/40 text-transparent'
                  }`}
                >
                  <Check className={`w-3.5 h-3.5 stroke-[3] transition-opacity ${deleteVersionFiles ? 'opacity-100' : 'opacity-0'}`} />
                </button>
              </div>
